...
class HealthIcon extends FlxSprite
{
	...
	public function new(char:String = 'bf', isPlayer:Bool = false)
	{
		...
		switch (char) {
				...
				animation.add('cloud', [0, 1], 0, false, isPlayer);
                        case 'sadcloud':
				loadGraphic(Paths.image('icons/icon-cloud'), true, 150, 150);
				animation.add('sadcloud', [0, 1], 0, false, isPlayer);
                        case 'tiredcloud':
				loadGraphic(Paths.image('icons/icon-cloud'), true, 150, 150);
	...
	default:
		...
		animation.add('cloud', [10, 11], 0, false, isPlayer);
		animation.add('sadcloud', [10, 11], 0, false, isPlayer);
		animation.add('tiredcloud', [10, 11], 0, false, isPlayer);
		animation.add('cloudPixel', [10, 11], 0, false, isPlayer);
